...
const RISKS = [
  {
    ...
    answer: "Bennybooks runs on Composio's managed tool surface instead.",
  },
  {
    label: "EXPOSED CREDENTIALS",
    description:
      "API keys stored in plaintext on your machine. 900+ instances found leaking tokens.",
    answer: "Bennybooks never gives the agent a raw key.",
  },
  {
    ...
    answer: "Bennybooks sandboxes all execution remotely.",
  },
] as const;
